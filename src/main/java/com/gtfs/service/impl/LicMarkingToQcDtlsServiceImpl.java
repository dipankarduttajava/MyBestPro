...
public class LicMarkingToQcDtlsServiceImpl implements LicMarkingToQcDtlsService,Serializable{
	...
	public List<LicOblApplicationMst> findIndividualMarkingDtlsByDate(Date fromDate,Date toDate, List<LicHubMst> licHubMsts, BranchMst branchMst, Long branchId){
		return licMarkingToQcDtlsDao.findIndividualMarkingDtlsByDate(fromDate, toDate, licHubMsts, branchMst, branchId);
	}
